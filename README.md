# Edwin EDA test rulebooks

Test rulebooks for end-to-end verification of Edwin's Ansible Event-Driven
Ansible (EDA) integration against Ansible Automation Platform (AAP).

## Rulebooks

### `rulebooks/edwin-eda-smoke.yml`
...
3. **Rulebook Activation** — create an activation that:
   - uses this project,
   - selects `rulebooks/edwin-eda-smoke.yml`,
